...
def app():
    ...
    if upload_df_2 is not None:
        ...
        with col_option2:
            ...
            exclude_values = st.multiselect('Exclude Values', df[exclude_column].unique(), [])
        # exclude logic
        ...
        df_3 = df_3_true.merge(df_3_false, on='time')
        df_3 = df_3.merge(df_3_null, on='time')
        ...
        with col_option2:
            ...
            display_columns = st.multiselect('Select Display Columns', ratio_columns, [])
        st.line_chart(df_3)
